...
abstract class AppLocalizations {
  ...
  /// Instruction text for random menu button
  ///
  /// In en, this message translates to:
  /// **'Tap to random delicious menu'**
  String get tapToRandomMenu;

  /// Random menu button text
  ///
  /// In en, this message translates to:
  /// **'Random Menu'**
  String get randomMenu;

  /// Header text for recommended menu card
  ///
  /// In en, this message translates to:
  /// **'Recommended Menu'**
  String get recommendedMenu;

  /// Error message when random menu fails
  ///
  /// In en, this message translates to:
  /// **'Cannot random menu. Please try again.'**
  String get cannotRandomMenu;

  /// Text when menu has no ratings
  ///
  /// In en, this message translates to:
  /// **'No rating yet'**
  String get noRating;
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['en', 'ja', 'th', 'zh'].contains(locale.languageCode);
